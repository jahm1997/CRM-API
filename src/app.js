...
server.use((req, res, next) => {
  ...
  res.header("Access-Control-Allow-Origin", "https://crm-front-n1a6znp3q-cristopherareche.vercel.app"); // update to match the domain you will make the request from
